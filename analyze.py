...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_file', dest='model_file', metavar='MODEL_PATH', type=str, required=True, help='Path to model file')
    parser.add_argument('--model_name', dest='model_name', metavar='MODEL_NAME', type=str, required=True, help='name of model eg resnet18, dexnet3')
